package guide.protocol.http.xml.server;
...
import guide.protocol.http.xml.codec.HttpXmlRequest;
import guide.protocol.http.xml.codec.HttpXmlResponse;
import guide.protocol.http.xml.pojo.Address;
