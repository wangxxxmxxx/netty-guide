package guide.protocol.http.xml.client;

import guide.protocol.http.xml.codec.HttpXmlRequestEncoder;
import guide.protocol.http.xml.codec.HttpXmlResponseDecoder;
